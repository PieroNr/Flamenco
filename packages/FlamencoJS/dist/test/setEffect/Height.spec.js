...
const Height_1 = require("../../src/setEffect/Height");
describe('Height', function () {
    let height;
    beforeEach(function () {
        height = new Height_1.default();
    });
    it('should set height correctly', function () {
        ...
        (0, chai_1.expect)(style1.height).to.equal('60px'); // Assurez-vous d'ajuster cette valeur en fonction de votre implémentation spécifique
        (0, chai_1.expect)(style2.height).to.equal('90px'); // Assurez-vous d'ajuster cette valeur en fonction de votre implémentation spécifique
    });
});
//# sourceMappingURL=Height.spec.js.map